...
export declare const useLike: () => {
    ...
    key?: import('@pinia/colada').EntryKey | ((vars: NoInfer<uni.item.Item>) => import('@pinia/colada').EntryKey);
    ...
    error: import('vue').ShallowRef<Error>;
    isLoading: import('vue').ComputedRef<boolean>;
    variables: import('vue').ShallowRef<uni.item.Item>;
